                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        <div class="text-center">
                            <img class="profile-user-img img-fluid img-circle" src="<?php echo base_url('public/photos/' . $this->session->userdata('photo')); ?>" alt="User profile picture">
                        ...
                        <button class="btn btn-primary btn-block" onclick="upload_photo()"><i class="fa fa-camera"></i> Change Photo</a></button>
                    </div>
                    <!-- /.card-body -->
                </div>
                <!-- /.card -->
...
<script type="text/javascript">
    ...
    function update(id) {
        ...
        $('.help-block').empty();
        $.ajax({
            url: "<?php echo site_url('profil/upload_photo/') ?>" + id,
            type: "GET",
            dataType: "JSON",
