        ...
        <div class="row align-items-center">
            <div class="col-lg-8 mx-auto text-center">
                ...
                <div class="d-flex justify-content-center gap-3" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <span class="badge bg-white text-primary px-3 py-2">
                        <i class="fas fa-graduation-cap me-2"></i>Kemahasiswaan
                    </span>
                </div>
            </div>
        </div>
...
<div class="container my-5">
    <div class="row">
        <div class="col-lg-8 mx-auto">
            ...
            <!-- Navigation to other kemahasiswaan pages -->
            <?php if (!empty($kemahasiswaan_menu) && count($kemahasiswaan_menu) > 1): ?>
                <div class="mt-5">
                    <h4 class="mb-3">Halaman Kemahasiswaan Lainnya</h4>
                    <div class="row">
                        <?php foreach ($kemahasiswaan_menu as $menu_item): ?>
                            <?php if ($menu_item->slug !== $item->slug): // Don't show current page
                            ?>
                                <div class="col-md-6 mb-3">
                                    <a href="<?= site_url('kemahasiswaan/' . $menu_item->slug) ?>"
