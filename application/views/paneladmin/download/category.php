    ...
    <div class="col-12">
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Master Data Category</h3>
                <button class="card-title btn btn-success btn-sm float-right" onclick="add_category()"><i class="fa fa-plus"></i> Add</a></button>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        table = $('#table').DataTable({
            ...
            "lengthChange": true,
            "ajax": {
                "url": "<?php echo site_url('admin/files/category/ajax_list') ?>",
                "type": "POST",
                "data": function(d) {
    ...
    function add_category() {
        ...
        $('.modal-title').text('Add Category Download');
    }
    ...
    function edit_category(id) {
        ...
        $('.help-block').empty();
        $.ajax({
            url: "<?php echo site_url('admin/files/category/ajax_edit/') ?>" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data) {
                ...
                $('#modal_form').modal('show');
                $('.modal-title').text('Edit Category Downlod');
            },
    ...
    function delete_category(id) {
        if (confirm('Are you sure delete this data?')) {
            $.ajax({
                url: "<?php echo site_url('admin/files/category/ajax_delete/') ?>" + id,
                type: "POST",
                data: {
    ...
    $('#btnSave').click(function() {
        var url;
        if (save_method == 'add') {
            url = "<?php echo site_url('admin/files/category/ajax_add') ?>";
        } else {
            url = "<?php echo site_url('admin/files/category/ajax_update') ?>";
        }
