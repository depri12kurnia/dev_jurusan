    ...
    <div class="col-12">
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Master Data Registrant</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
            ...
            <div class="modal-body">
                <form id="resetPasswordForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="modal_username" name="username" class="form-control" readonly>
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        table = $('#table').DataTable({
            ...
            "lengthChange": true,
            "ajax": {
                "url": "<?php echo site_url('admin/registrant/ajax_list') ?>",
                "type": "POST",
                "data": function(d) {
    ...
    function edit_user(id) {
        ...
        $('.help-block').empty();
        $.ajax({
            url: "<?php echo site_url('admin/registrant/ajax_edit/') ?>" + id,
            type: "GET",
            dataType: "JSON",
    ...
    function delete_user(id) {
        if (confirm('Are you sure delete this data?')) {
            $.ajax({
                url: "<?php echo site_url('admin/registrant/ajax_delete/') ?>" + id,
                type: "POST",
                data: {
    ...
    $('#btnSave').click(function() {
        var url;
        if (save_method == 'add') {
            url = "<?php echo site_url('admin/registrant/ajax_add') ?>";
        } else {
            url = "<?php echo site_url('admin/registrant/ajax_update') ?>";
        }
    ...
    // Fungsi untuk membuka modal dengan data user
    ...
    function submitResetPassword() {
        $.ajax({
            url: "<?= base_url('admin/registrant/reset_password') ?>",
            type: "POST",
            data: $('#resetPasswordForm').serialize() + '&csrf_token_jkt3=' + getCsrfToken(),
            dataType: "json",
            beforeSend: function(xhr) {
                xhr.setRequestHeader("X-CSRF-Token", getCsrfToken());
            },
            success: function(response) {
                ...
                if (response.csrf_token) {
                    document.cookie = "csrf_cookie_jkt3=" + response.csrf_token + "; path=/";
                    $('input[name="csrf_token_jkt3"]').val(response.csrf_token);
                }
            },
            error: function() {
