            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number"><?php echo $dosen_count; ?></span>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Dosen Aktif</span>
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number"><?php echo count($prodi_stats); ?></span>
                    </div>
                </div>
            </div>
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box mb-3">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">
                            <a href="<?php echo base_url('admin/dosen/report'); ?>" class="btn btn-sm btn-primary">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <button type="button" class="btn btn-primary btn-sm" onclick="add_dosen()">
...
<div class="modal fade" id="modal-import" tabindex="-1" role="dialog" aria-labelledby="modal-import-label" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal-import-label">Import Data Dosen</h5>
            ...
            <form id="form-import" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="alert alert-info">
                        ...
                        <a href="<?php echo base_url('admin/dosen/download_template'); ?>" class="btn btn-sm btn-outline-primary">
...
<script>
    ...
    function refreshCsrfToken() {
        $.get('<?php echo base_url('admin/dosen/get_csrf_token'); ?>', function(response) {
    ...
    $(document).ready(function() {
        ...
        table = $('#table-dosen').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?php echo base_url('admin/dosen/ajax_list'); ?>",
                "type": "POST",
                "data": function(d) {
                    d[csrfName] = csrfHash;
                    return d;
    ...
    function add_dosen() {
        window.location.href = '<?php echo base_url('admin/dosen/add'); ?>';
    }

    function edit_dosen(id) {
        window.location.href = '<?php echo base_url('admin/dosen/edit/'); ?>' + id;
    }

    function view_dosen(id) {
        $.ajax({
            url: '<?php echo base_url('admin/dosen/view/'); ?>' + id,
            type: 'GET',
            dataType: 'json',
                        ...
                        <div class="col-md-6">
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    ...
                                    <td>: ${data.nama_gelar || data.nama_lengkap}</td>
                                </tr>
                                <tr>
    ...
    function export_excel() {
        window.location.href = '<?php echo base_url('admin/dosen/export_excel'); ?>';
    }
    ...
    $('#form-import').on('submit', function(e) {
        ...
        $.ajax({
            url: '<?php echo base_url('admin/dosen/import_excel'); ?>',
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
