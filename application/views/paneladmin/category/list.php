...
<script type="text/javascript">
    ...
    function edit_category(id) {
        ...
        $('.help-block').empty();
        $.ajax({
            url: "<?php echo site_url('admin/category/ajax_edit/') ?>" + id,
            type: "GET",
            dataType: "JSON",
    ...
    function delete_category(id) {
        if (confirm('Are you sure delete this data?')) {
            $.ajax({
                url: "<?php echo site_url('admin/category/ajax_delete/') ?>" + id,
                type: "POST",
                data: {
    ...
    $('#btnSave').click(function() {
        var url;
        if (save_method == 'add') {
            url = "<?php echo site_url('admin/category/ajax_add') ?>";
        } else {
            url = "<?php echo site_url('admin/category/ajax_update') ?>";
        }
